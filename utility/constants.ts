...
export const HackScripts = [
  ScriptNames.hack_script, ScriptNames.grow_script, ScriptNames.weaken_script, ScriptNames.hwg_script, 
  ScriptNames.logger, ScriptNames.constants, ScriptNames.network_packets, ScriptNames.flags,
]
